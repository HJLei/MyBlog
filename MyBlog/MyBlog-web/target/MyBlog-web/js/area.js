...
function bgFun(b){
    //if(b=="晴"){
    //	$(".content").css("background","url(../images/qing.jpg) no-repeat 0 0");
    //}else if(b=="晴转多云" || b=="阴" || b=="多云"){
    //	$(".content").css("background","url(../images/duoyun.png) no-repeat 0 0");
    //}else if(b=="小雨" || b=="中雨" ||b=="大雨"){
    //	$(".content").css("background","url(../images/yu.jpg) no-repeat 0 0");
    //}else if(b=="雷雨" || b=="雷阵雨"){
    //	$(".content").css("background","url(../images/leiyu.png) no-repeat 0 0");
    //}
}
